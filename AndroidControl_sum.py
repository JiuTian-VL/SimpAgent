...
data = json.load(open('/data7/Users/zxr/hyh/SimpAgent-main/androidcontrol_eval/androidcontrol_bs128_lr3e-4_mask535_drop6_eval/AndroidControl_results.json', 'r'))
...
for record in gt_test:
    try:
        ...
        gt_dict = json.loads(preprocess_json_string(record["gt"]))
